...
export const Footer = () => {
  return (
    <>
        <footer class="bg-primaryColor shadow dark:bg-gray-900 w-full">
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <ul class="flex md:flex-row flex-col gap-4 m-4 flex-wrap text-md items-center justify-center mb-6 font-medium text-gray-500 md:mb-0 dark:text-gray-400">
                        <li>
                ...
                <span class="block text-md text-gray-500 md:text-center dark:text-gray-400 text-center">© 2023 <a href="#" class="hover:underline">BoosTiger</a>. All Rights Reserved.</span>
            </div>
        </footer>
    </>
  )
